...
export function MoneyFlow() {
  ...
  const regrasDoFormulario = z.object({
    ...
    valor: z.number().positive("O valor não pode ser zero ou negativo"),
  });
  ...
  function enviarFormulario(camposDoFormulario: TypeForm) {
    setListaLancamentos((oldState) => [...oldState,camposDoFormulario]);
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-center items-center bg-gray-100'>
      ...
      <div
        className={`w-full max-w-6xl flex ${listaLancamentos.length > 0? 'justify-between items-start': 'justify-center items-center' } gap-20`}
      >
        <form
